...
const DEFAULT_METHODS = [
  ...
  { key: 'omari', label: 'Omari', enabled: true, note: null, sortOrder: 1 },
  { key: 'crypto', label: 'Crypto', enabled: true, note: null, sortOrder: 2 },
  { key: 'card', label: 'Card', enabled: false, note: 'Coming soon', sortOrder: 3 },
]

const LABELS = { ecocash: 'EcoCash', omari: 'Omari', crypto: 'Crypto', card: 'Card' }
