...
export async function buildTicketsPdf({ order, baseUrl }) {
  ...
  doc.fillColor('#111111').fontSize(18).text('Shoppy Tickets', 40 + (hasLogo ? 36 : 0), headerTop + 2)
  doc.fillColor('#6B7280').fontSize(9).text('Ticket template v2', 40 + (hasLogo ? 36 : 0), headerTop + 24)
