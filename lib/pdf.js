...
export async function buildTicketsPdf({ order, baseUrl }) {
  ...
  for (let idx = 0; idx < items.length; idx++) {
    ...
    const hasBanner = Boolean(eventCoverImage)
    const headerTitleColor = hasBanner ? rgb(1, 1, 1) : rgb(0.07, 0.07, 0.07)
    const headerMetaColor = hasBanner ? rgb(0.92, 0.93, 0.94) : rgb(0.42, 0.45, 0.5)
