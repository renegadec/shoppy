...
/**
 * Generate a numeric-style reference for EcoCash V3 requests.
 * EcoCash's sample clientCorrelator values are numeric (e.g. 1763385010).
 * UUIDs with dashes can cause "Resource not found" on status lookups.
 */
export function generateEcoCashRef() {
