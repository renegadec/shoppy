...
export const DEFAULT_PRICING_SETTINGS = [
  ...
  {
    key: 'zesa_markup_rate',
    value: 0.01,
    note: 'Markup rate added on top of ZESA token amount (e.g. 0.01 = 1%)',
  },
  {
    key: 'usd_zig_rate',
    value: 25,
    note: '1 USD = X ZiG conversion rate for cross-currency purchases (e.g. USD pay → ZiG ZESA)',
  },
]
